...
router.put('/', async(req, res) => {
  ...
  if (hasLawyer) {
    await Lawyer.update({ firstname, lastname, fathersname, email, city  }, {where: { email: currentUserEmail }})
    ...
    await Client.update({ firstname, lastname, fathersname, email, city }, { where: { email: currentUserEmail } })
